///
/// 
/// removed quaternion and position from arguments because i didnt need them
/// 
/// 
/// 
/// 
...
public static class ObjectPooling
{
    ...
    class Pool
    {
        ...
        public GameObject Spawn(bool setActive = true)
        {
            ...
            else
            {
                ...
                if (obj == null) //|| obj.activeInHierarchy)// SILVARC EDIT!!! or active in hierarchy ???
                {
    ...
    /// call that function.
    /// </summary>
    static public GameObject Spawn(GameObject prefab, bool setActive = true)
    {
        Init(prefab);

        return pools[prefab].Spawn(setActive);
    }
